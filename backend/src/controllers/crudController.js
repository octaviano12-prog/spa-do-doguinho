...
const allowed = {
  ...
  appointments: ["customer_id", "pet_id", "service_id", "scheduled_at", "status", "notes", "total_price", "payment_status", "payment_method", "paid_at", "mercado_pago_id"],
  payments: ["appointment_id", "amount", "method", "type", "status", "description", "paid_at", "mercado_pago_id", "external_reference"],
  ...
  stock_items: ["name", "category", "quantity", "min_quantity", "cost_price", "sale_price", "unit", "supplier", "barcode", "notes", "active"],
  ...
  gallery: ["title", "image_url", "description", "category", "active", "sort_order"],
  availability: ["day_of_week", "enabled", "start_time", "end_time", "interval_minutes", "max_appointments_per_slot"],
  availability_rules: ["date", "start_time", "end_time", "type", "reason", "active"],
  blocked_dates: ["date", "time", "reason"],
