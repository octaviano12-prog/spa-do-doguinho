...
import { CalendarDays, PackageWarning, PawPrint, Users, Wallet } from "lucide-react";
...
export default function Dashboard() {
  const [data, setData] = useState({ cards: {}, byStatus: [], cashFlow: [] });

  useEffect(() => {
    client.get("/dashboard/summary").then((res) => setData(res.data)).catch(() => {});
  }, []);
  ...
  return (
    <>
      ...
      <div className="grid cards">
        ...
        <StatCard title="Estoque baixo" value={data.cards.lowStock || 0} icon={PackageWarning} />
      </div>
