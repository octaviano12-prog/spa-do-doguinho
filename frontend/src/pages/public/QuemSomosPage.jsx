  ...
  return (
    <PublicLayout>
      <main className="overflow-hidden bg-[#fffdf7] text-[#12382f]">
        <section className="relative h-[calc(100vh-128px)] min-h-[585px] overflow-hidden bg-[linear-gradient(135deg,#fffdf7,#e6f5eb,#fff8e6)]">
          ...
          <div className="relative mx-auto grid h-full max-w-[1880px] gap-10 px-6 py-5 md:px-10 lg:grid-cols-[1fr_.9fr] lg:items-center">
            <div className="max-w-4xl -translate-y-2">
