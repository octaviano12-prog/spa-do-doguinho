      ...
      <main className="overflow-hidden bg-[#fbf7ef] text-[#10231a]">
          ...
          <div className="mx-auto grid max-w-[1680px] gap-10 xl:grid-cols-[.9fr_1.1fr] xl:items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="mt-9 flex flex-wrap gap-4">
                ...
                <a href={whatsappUrl} target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-2xl border border-slate-300 bg-white px-8 py-4 font-black text-[#10231a] shadow-sm transition hover:border-emerald-700">
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={title} className="rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-black/5">
                    <Icon className="mb-4 text-[#0f7a3b]" size={32} />
            ...
            <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} className="rounded-[36px] bg-white p-6 shadow-2xl ring-1 ring-black/5 md:p-8">
              <img src={publicPhotos.vetCare} alt="Contato SPA do Doguinho" className="mb-7 h-[290px] w-full rounded-[28px] object-cover" />
              ...
              <div className="grid gap-4">
                ...
                <a href={whatsappUrl} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-3 rounded-2xl bg-[#0f7a3b] py-5 text-lg font-black text-white transition hover:bg-[#0b6631]">
                  <Send size={20} />
        ...
        <section className="mx-auto grid max-w-[1680px] gap-6 px-5 py-16 md:px-8 lg:grid-cols-3">
          ...
          <div className="rounded-[36px] bg-[#10231a] p-8 text-white shadow-2xl">
            ...
            <div className="mt-8 rounded-3xl bg-[#0f7a3b] p-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                <div key={title} className="rounded-3xl bg-slate-50 p-6">
                  <Icon className="mb-4 text-[#0f7a3b]" size={34} />
