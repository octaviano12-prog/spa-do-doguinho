...
export default function AgendamentoPage() {
  ...
  const paymentOptions = useMemo(() => [
    Number(paymentSettings.pix_enabled ?? 1) ? ["pix", QrCode, "PIX", "Pagamento via PIX com QR Code."] : null,
  ...
  const paymentInstruction = form.paymentMethod === "pix"
    ? hasRealPix ? "PIX gerado com sucesso. Pague pelo QR Code ou copie o código PIX abaixo." : "Seu agendamento foi registrado e o pagamento PIX ficou pendente. Configure o Access Token do Mercado Pago para gerar QR Code real."
    : form.paymentMethod === "card"
      ? "Seu agendamento foi registrado com pagamento por cartão. A cobrança online será ativada na integração de cartão."
